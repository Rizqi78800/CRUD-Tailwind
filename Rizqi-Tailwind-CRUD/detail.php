    ...
    <div class="container mx-auto my-5">
        <div class="bg-blue-400 rounded-xl shadow-md p-6 w-2/3 mx-auto">
            ...
            <div class="text-center">
                <a href="index.php" class="bg-cyan-600 hover:bg-cyan-800 hover:shadow-sm shadow-slate-700 text-white py-2 px-4 rounded-full inline-block transition-all duration-200">Back</a>
            </div>
        </div>
    </div>
